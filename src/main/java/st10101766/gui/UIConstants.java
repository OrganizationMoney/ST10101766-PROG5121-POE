...
public class UIConstants {
    public static final String APP_TITLE = "QuickChat";
    ...
    public static final Color BUTTON_COLOR = new Color(37, 211, 102); // WhatsApp green
    public static final Color SUCCESS_COLOR = new Color(37, 211, 102); // Green
    ...
    public static final Color HINT_COLOR = new Color(120, 120, 120); // Light gray
